...
| X-2         | 60-key (5x12), un-split, ortholinear, MX/choc, GH60-compatible, "show the components"  | ![](https://github.com/rgoulter/keyboard-labs/blob/master/docs/images/photo-keyboard-x-1-mx-tented.JPG)     |
