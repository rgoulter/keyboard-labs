...
Comment1 "Upgrades rev2020.1 keyboard PCB to rev2021.2"
Comment2 ""
Comment3 ""
Comment4 ""
$EndDescr
...
The actual MiniF4 dev board should be socketed\nor otherwise connected to U_1.
Text Notes 7250 2700 0    50   ~ 0
This symbol has the same arrangement as the U_1\nof rev2020.1.\n(i.e. uses PA11 for SW15, PA12 for SW21, PB2 for SW31).\n\nThe daughterboard is mounted to rev2020.1 PCBs\nwith this footprint, in place of the microcontroller.
