...
// // Linux, Gnome shell
pub const LINUX_DESKTOP_LEFT: Action =
    Action::MultipleKeyCodes(&[LeftControl, LeftAlt, LeftArrow].as_slice());
pub const LINUX_DESKTOP_RIGHT: Action =
    Action::MultipleKeyCodes(&[LeftControl, LeftAlt, RightArrow].as_slice());
//
// // Windows 10
