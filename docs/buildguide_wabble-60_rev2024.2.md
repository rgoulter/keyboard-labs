...
<img src="images/keyboards/wabble-60/wabble-60.JPG" />
...
<img src="images/buildlog-rev2021.4-minimal/tools.JPG" />
...
1. Solder a PH2.0 connector to the LiPo battery.
    ...
    <img src="images/buildlog-wabble-60-rev2024.2/00_0_battery.JPG" />

    <img src="images/buildlog-wabble-60-rev2024.2/00_1_battery.JPG" />
...
2. Socket the WeAct BLE core board.
    ...
    <img src="images/buildlog-wabble-60-rev2024.2/01_0_coreboard.JPG" />

    Cut the header pins down to an appropriate number.

    <img src="images/buildlog-wabble-60-rev2024.2/01_1_coreboard.JPG" />

    Solder the round-pin headers to the core board:

    <img src="images/buildlog-wabble-60-rev2024.2/01_2_coreboard.JPG" />

    The pins can be cut, and the solder joints reflowed,
     which hopefully looks a bit neater than leaving the pins untrimmed:

    <img src="images/buildlog-wabble-60-rev2024.2/01_3_coreboard.JPG" />
...
3. Solder the USB connector.
    ...
    <img src="images/buildlog-wabble-60-rev2024.2/02_0_usb.JPG" />

    <img src="images/buildlog-wabble-60-rev2024.2/02_1_usb.JPG" />

4. Solder the LiPo charging circuitry.

    Solder the TP4054 to U2:

    <img src="images/buildlog-wabble-60-rev2024.2/03_0_tp4045.JPG" />

    <img src="images/buildlog-wabble-60-rev2024.2/03_1_tp4054.JPG" />
    ...
    <img src="images/buildlog-wabble-60-rev2024.2/03_2_tp4054.JPG" />

    Solder the BSS138 to Q1:

    <img src="images/buildlog-wabble-60-rev2024.2/04_0_fet.JPG" />
    <img src="images/buildlog-wabble-60-rev2024.2/04_1_fet.JPG" />
...
5. Solder the switch diodes.
    ...
    <img src="images/buildlog-wabble-60-rev2024.2/05_0_diodes.JPG" />

    <img src="images/buildlog-wabble-60-rev2024.2/05_1_diodes.JPG" />
...
6. Solder the tall through-hole components.
    ...
    <img src="images/buildlog-wabble-60-rev2024.2/06_0_th.JPG" />
    <img src="images/buildlog-wabble-60-rev2024.2/06_1_th.JPG" />
...
7. Check the USB connector and LiPo charging.
    ...
    <img src="images/buildlog-wabble-60-rev2024.2/09_batt_charge.JPG" />
    <img src="images/buildlog-wabble-60-rev2024.2/09_batt_full.JPG" />
